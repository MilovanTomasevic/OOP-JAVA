...
public class Main {
...

    {
        ...
        /*
		Sfera s = null;
		// Poziv metoda zapremina() nad nepostojecim objektom dovodi do
		// izbacivanja izuzetka NullPointerException nakon pokretanja programa
		System.out.println(s.zapremina());
		*/
