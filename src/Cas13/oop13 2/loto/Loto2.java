 ...
 */
public class Loto2 extends Application {
		...
		for(int i = 0; i < brojevi.length; i++){
			...
			brojevi[i].setOnAction(new EventHandler<ActionEvent>() {
				...
				public void handle(ActionEvent e) {
					// Kako pristupiti dugmetu?
					// Dogadjaj (objekat klase ActionEvent, na koji referise promenljiva e)
					// zna nad kojim cvorom se desio - metodom getSource() za objekat dogadjaj 
					// dobija se referenca na cvor. Tip reference je Object, pa je potrebno 
					// kastovanje u konkretan tip cvora. 
					Button dugme = (Button)e.getSource();
