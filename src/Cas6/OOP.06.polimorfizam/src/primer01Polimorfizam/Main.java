...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Mozemo da instanciramo i klasu Oblik, ali to ne cinimo jer nije u potpunosti definisano
		// njeno ponasanje
		...
		for (int i = 0; i < oblici.length; i++) { 	// alternativni nacin da iteriramo
			...
			if (o instanceof Pravougaonik) {
                ...
                // Metod opisaniKrug() klase Pravougaonik ne ispunjava uslove za polimorfizam
