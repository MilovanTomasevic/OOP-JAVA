...
/**
 * Primer ilustruje kako se moze proveriti da li je string
 * podstring/prefiks/sufiks datog stringa,
 * kao i izdvajanje podstringa za date indekse.
 */
public class Primer04Podstring {
    public static void main(String[] args) {
        ...
        show("t.substring(16)", t.substring(16));
