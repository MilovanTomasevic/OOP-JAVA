...
/**
 * Primer ilustruje razliku u brzini spajanja stringova koristeci 'String' i 'StringBuilder'.
 */
public class Primer04StringVSStringBuilder {
    ...
    static void runStringTest() {
        ...
        for (int i = 0; i < TEST_SIZE; i++) {
            ...
            // logging
            if (i % 100 == 0) System.out.println("String: " + i);
        }
    }
    ...
    static void runStringBuilderTest() {
        ...
        for (int i = 0; i < TEST_SIZE; i++) {
            sb.append(word);
            if (i % 100 == 0) System.out.println("isb: " + i);
        }
    }
}
