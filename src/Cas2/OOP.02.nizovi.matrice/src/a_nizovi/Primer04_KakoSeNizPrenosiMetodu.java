 ...
 */
public class Primer04_KakoSeNizPrenosiMetodu {

	// Evo primera kako mozemo napraviti globalnu promenljivu.
	// Primetimo da je mozemo inicijalizovati takodje.
	// Ovo je pre svega korisno kada se promenljiva
	// koristi u vise pomocnih metoda.
	...
	public static void main(String[] args) {
		...
		final int c = sc.nextInt(); // final oznacava konstantu
