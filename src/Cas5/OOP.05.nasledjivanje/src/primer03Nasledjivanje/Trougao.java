...
public class Trougao extends Oblik {
	...
	public Trougao(Tacka a, Tacka b, Tacka c) {
		...
		// privremeni objekat koji se prosledjuje konstruktoru natklase,
		// a konstruktor natklase pravi sopstvenu kopiju od privremenog objekta.
	...
	public String toString() {
		return "Trougao centar = " + centar + " a = " + a + " b = " + b + " c = " + c;
	}
}
